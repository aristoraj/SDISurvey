  ...
  return (
    <div>
      ...
      <div className="space-y-4 mt-4">
        <QuestionBlock number="19a" label={tr.q19a} required error={e.interventionPercentages}>
        ...
        <QuestionBlock number="19b" label={tr.q19b}>
          <TextArea value={formData.interventionOther} onChange={v => updateData({ interventionOther: v })} placeholder={tr.leaveBlank} />
        </QuestionBlock>
      </div>
    </div>
  );
