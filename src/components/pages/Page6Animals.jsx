...
export default function Page6Animals({ tr, formData, updateData }) {
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <QuestionBlock number="18a" label={tr.q18a} required>
        ...
        <QuestionBlock number="18b" label={tr.q18b}>
          <TextInput
            value={formData.animalOther}
            onChange={v => updateData({ animalOther: v })}
